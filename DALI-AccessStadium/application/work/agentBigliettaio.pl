...
evi(condizione_bigliettaio):-condizione_bigliettaio(var_X),true==var_X,a(vendi_biglietto).

a(vendi_biglietto):-write('Attendo agenti'),nl.

eve(richiesta_acquisto(var_Id_agente)):-number_chars(var_Id_agente,var_Char),atom_chars(var_Id_agenteString,var_Char),atom_concat('agent',var_Id_agenteString,var_X),a(message(var_X,send_message(biglietto_acquistato,var_Me))),format('Sto vendendo il biglietto all agente ~d',var_Id_agente),nl.
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_80637,var_Ontology,_80641),_80631),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_80675)),a(message(var_Ag,propose(var_A,[_80675],var_AgI))),retractall(ext_agent(var_Ag,_80713,var_Ontology,_80717)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_80511,var_Ontology,_80515),_80505),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_80581,var_Ontology,_80585)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_80399,var_Ontology,_80403),_80393),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_80455,var_Ontology,_80459)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_79963),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_79997),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_79779).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_79627),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_79575),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_79451,_79453)),clause(agente(_79473,_79475,_79477,var_S),_79469),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_79245,_79247,_79249,var_S),_79241),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_79345,[]),repeat,read(_79345,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_79345).
