...
eve(sveglia):-a(vai_tornello).

a(vai_tornello):-biglietto_comprato(var_X),true==var_X->write('Ho il biglietto'),nl,a(message(agentTornello,send_message(richiesta_ingresso(4,0),var_Me)));write('Non ho il biglietto, lo compro'),nl,a(compra_biglietto).

a(compra_biglietto):-a(message(agentBigliettaio,send_message(richiesta_acquisto(4),var_Me))),write('Sto comprando il biglietto').
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_89779,var_Ontology,_89783),_89773),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_89817)),a(message(var_Ag,propose(var_A,[_89817],var_AgI))),retractall(ext_agent(var_Ag,_89855,var_Ontology,_89859)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_89653,var_Ontology,_89657),_89647),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_89723,var_Ontology,_89727)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_89541,var_Ontology,_89545),_89535),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_89597,var_Ontology,_89601)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_89105),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_89139),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_88921).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_88769),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_88717),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_88593,_88595)),clause(agente(_88615,_88617,_88619,var_S),_88611),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_88387,_88389,_88391,var_S),_88383),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_88487,[]),repeat,read(_88487,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_88487).
