...
:-assert(informazioni_agente(3,1)).

eve(sveglia):-a(message(agent4,send_message(sveglia,var_Me))),a(vai_tornello).

a(vai_tornello):-biglietto_comprato(var_X),true==var_X->write('Ho il biglietto'),nl,a(message(agentTornello,send_message(richiesta_ingresso(3,1),var_Me)));write('Non ho il biglietto, lo compro'),nl,a(compra_biglietto).

a(compra_biglietto):-a(message(agentBigliettaio,send_message(richiesta_acquisto(3),var_Me))),write('Sto comprando il biglietto'),nl.
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_91431,var_Ontology,_91435),_91425),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_91469)),a(message(var_Ag,propose(var_A,[_91469],var_AgI))),retractall(ext_agent(var_Ag,_91507,var_Ontology,_91511)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_91305,var_Ontology,_91309),_91299),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_91375,var_Ontology,_91379)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_91193,var_Ontology,_91197),_91187),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_91249,var_Ontology,_91253)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_90757),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_90791),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_90573).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_90421),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_90369),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_90245,_90247)),clause(agente(_90267,_90269,_90271,var_S),_90263),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_90039,_90041,_90043,var_S),_90035),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_90139,[]),repeat,read(_90139,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_90139).
