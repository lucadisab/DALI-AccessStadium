...
eve(sveglia):-a(message(agent3,send_message(sveglia,var_Me))),a(vai_tornello).

a(vai_tornello):-biglietto_comprato(var_X),true==var_X->write('Ho il biglietto'),nl,a(message(agentTornello,send_message(richiesta_ingresso(2,0),var_Me)));write('Non ho il biglietto, lo compro'),nl,a(compra_biglietto).

a(compra_biglietto):-a(message(agentBigliettaio,send_message(richiesta_acquisto(2),var_Me))),write('Sto comprando il biglietto').
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_91261,var_Ontology,_91265),_91255),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_91299)),a(message(var_Ag,propose(var_A,[_91299],var_AgI))),retractall(ext_agent(var_Ag,_91337,var_Ontology,_91341)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_91135,var_Ontology,_91139),_91129),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_91205,var_Ontology,_91209)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_91023,var_Ontology,_91027),_91017),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_91079,var_Ontology,_91083)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_90587),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_90621),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_90403).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_90251),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_90199),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_90075,_90077)),clause(agente(_90097,_90099,_90101,var_S),_90093),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_89869,_89871,_89873,var_S),_89865),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_89969,[]),repeat,read(_89969,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_89969).
